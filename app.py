...
st.sidebar.write("This tool predicts safe, expected, and aggressive final scores using trained ML models.")
st.sidebar.write("It also compares rain-adjusted output with a simple DLS-style baseline.")

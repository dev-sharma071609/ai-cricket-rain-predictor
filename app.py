...
with right:
    ...
    with c1:
        ...
        overs_completed = st.number_input(
            ...
            value=31 if match_format == "ODI" else 12,
            step=1
        )
    with c2:
        balls_into_over = st.number_input(
            ...
            min_value=0,
            max_value=5,
            value=2 if match_format == "ODI" else 0,
            step=1
        )

    runs_last_6 = st.number_input("Runs in last 6 balls", min_value=0, max_value=36, value=5, step=1)
    wickets_last_6 = st.number_input("Wickets in last 6 balls", min_value=0, max_value=6, value=0, step=1)
    runs_last_12 = st.number_input("Runs in last 12 balls", min_value=0, max_value=72, value=13, step=1)
    wickets_last_12 = st.number_input("Wickets in last 12 balls", min_value=0, max_value=10, value=0, step=1)
